...
public class HTGLoggers extends JavaPlugin implements Listener, HTGLoggersAPI {
    ...
    public void onEnable() {
        ...
        // Rejestracja API
        getServer().getServicesManager().register(HTGLoggersAPI.class, this, this, ServicePriority.Normal);
    ...
    @Override
    public void createLogFile(String pluginName) {  // Zmieniono sygnaturę metody, usuwając drugi parametr.
