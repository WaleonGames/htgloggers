...
import pl.htgmc.htgloggers.placeholders.HTGLoggersPlaceholder;
...
public class HTGLoggers extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        if (Bukkit.getPluginManager().getPlugin("PlaceholderAPI") != null) {
            new HTGLoggersPlaceholder(this).register();
    ...
    private void checkForUpdates() {
        try {
            // Użyj bezpośredniego linku do pliku JSON na GitHubie
            URL url = new URL("https://raw.githubusercontent.com/WaleonGames/htgloggers/main/version.json");
